...
# Perform a search in the index, retrieving up to 500,000 matches
matches = index.search(query_embedding, 500000, exact=True)
...
# Save to CSV
output_path = "/home/miller/matches_exact_500000_F32_femicide.csv"
