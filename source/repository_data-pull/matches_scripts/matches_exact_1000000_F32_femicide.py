...
# Perform search - consider reducing from 1M if you don't need all results
print("performing semantic search")
matches = index.search(query_embedding, 1000000, exact=True)
...
# Save to CSV
output_path = "/home/miller/matches_exact_1000000_F32_femicide.csv"
